...
RUN apt-get update
RUN apt-get -y install language-pack-ja-base language-pack-ja fonts-ipafont-gothic dbus-x11 ibus-anthy python-appindicator xterm xfce4-terminal leafpad emacs vim-gtk
